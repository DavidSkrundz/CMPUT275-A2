...
if sys.platform == "darwin":
    tile_types = {
        -16711936:  Tile('plains', 0, True, 0, 0),
        -16777216:  Tile('wall', 1, False, 0, 0),
        -16776961:  Tile('water', 2, False, 0, 0),
        -910:  Tile('sand', 3, True, 0, 0),
        -10526881:  Tile('road', 4, True, 0, 0),
        -2631721:  Tile('mountain', 5, False, 1, 2),
        -16753123:  Tile('forest', 6, True, 2, 0)
    }
else:
    tile_types = {
